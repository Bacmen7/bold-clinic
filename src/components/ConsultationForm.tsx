      ...
      <div className="max-w-[1440px] mx-auto">
        ...
        <div className="mt-8 pt-6 border-t border-white/20">
          <div className="flex flex-col items-start gap-3">
            <p className="font-basis text-white/70 text-sm">
              Speak to our Patient Counsellor
            </p>
            <a
              href="tel:9833943177"
              className="font-basis text-white text-xl font-semibold hover:text-[#F6544A] transition-colors flex items-center gap-3 group"
            >
              <div className="w-10 h-10 rounded-full bg-[#F6544A]/10 border border-[#F6544A]/30 flex items-center justify-center group-hover:bg-[#F6544A]/20 transition-all">
                <svg className="w-5 h-5 text-[#F6544A]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z" />
                </svg>
              </div>
              <span>+91 98339-43177</span>
            </a>
          </div>
        </div>
          </div>
